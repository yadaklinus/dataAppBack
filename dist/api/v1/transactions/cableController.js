            ...
            sanitizedPackages[providerName] = providerArray.map(provider => {
                return {
                    ...
                    PRODUCT: provider.PRODUCT.map(product => {
                        ...
                        const { PRODUCT_DISCOUNT_AMOUNT, PRODUCT_DISCOUNT, MINAMOUNT, MAXAMOUNT, ...cleanProduct } = product;
                        return cleanProduct;
                    })
                };
            });
...
const purchaseSubscription = async (req, res) => {
    ...
    try {
        ...
        const actualKey = Object.keys(safePackages).find((key) => key.toUpperCase() === providerKey.toUpperCase());
