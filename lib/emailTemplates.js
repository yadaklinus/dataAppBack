        ...
        <div class="email-wrapper">
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <p>Hello <strong>${userName}</strong>,<br><br>We received a request to reset the password for your Data Padi account. Enter the authorization code below to successfully verify your identity.</p>
                ...
                <!-- Footer -->
                <div class="footer">
                    <p>© ${new Date().getFullYear()} Data Padi. All rights reserved.</p>
                    <p>Do you need help? <a href="mailto:support@datapadi.com">Contact Support</a></p>
                </div>
            </div>
        </div>
    </body>
