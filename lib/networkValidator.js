...
const NETWORK_PREFIXES = {
    ...
    "9_MOBILE": ['0809', '0817', '0818', '0908', '0909']
};
...
const validateNetworkMatch = (network, phone) => {
    ...
    const networkKey = network.toUpperCase().replace('9MOBILE', 'NINE_MOBILE');
    const prefixes = NETWORK_PREFIXES[networkKey];

    if (!prefixes) return true; // Fallback if network is unknown
